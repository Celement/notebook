...
<h2 id="OLF2q">2. 如何判断一个对象是否可以迭代</h2>
...
<h2 id="QojYx">4. iter()函数与next()函数</h2>
...
<h2 id="FYEji">5. 如何判断一个对象是否是迭代器</h2>
...
<h2 id="VMkHG">7. for...in...循环的本质</h2>
for **item** in **Iterable** 循环的本质就是先通过iter()函数获取可迭代对象Iterable的迭代器，然后对获取到的迭代器不断调用next()方法来获取下一个值并将其赋值给item，当遇到StopIteration的异常后循环结束。

<h2 id="EcTkt">8. 迭代器的应用场景</h2>
...
<h2 id="LGmHZ">9. 并不是只有for循环能接收可迭代对象</h2>
