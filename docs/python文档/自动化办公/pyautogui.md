规定规定2pyautogui 是一个纯 Python 的 GUI 自动化工具，通过它可以让程序自动控制鼠标和键盘的一系列操作来达到自动化测试的目的。
...
pyautogui.moveRel(200,400,duration=2)
```
...
![img](https://raw.githubusercontent.com/Celement/mypicture/main/202512130937878.webp)

点击下载ImageMaGICk的安装包(Windows) 
...
找到   site-packages\moviepy\config_defaults.py
...
IMAGEMAGICK_BINARY = os.getenv('IMAGEMAGICK_BINARY', 'D:\\ImageMagick\\ImageMagick-7.1.1-Q16-HDRI\\magick.exe')
```