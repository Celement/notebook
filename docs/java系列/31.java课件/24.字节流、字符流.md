...
![](assets/20201121085133.png)

-   构造方法

![](assets/20201121085134.png)
...
![](assets/20201121085137.png)

-   构造方法

![](assets/20201121085138.png)

#### FileInputStream类读取数据read方法

在读取文件中的数据时，调用read方法，实现从文件中读取数据

![](assets/20201121085139.png)
