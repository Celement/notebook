...
![](https://gitee.com/elementsong_admin/mdimage/raw/master/20201121125154.png)

线程：线程是进程中的一个执行单元，负责当前进程中程序的执行，一个进程中至少有一个线程。一个进程中是可以有多个线程的，这个应用程序也可以称之为多线程程序。

简而言之：一个程序运行后至少有一个进程，一个进程中可以包含多个线程

![](https://gitee.com/elementsong_admin/mdimage/raw/master/20201121125155.png)
...
![](https://gitee.com/elementsong_admin/mdimage/raw/master/20201121125156.png)
...
>   优先让优先级高的线程使用
>   CPU，如果线程的优先级相同，那么会随机选择一个(线程随机性)，Java使用的为抢占式调度。

![](https://gitee.com/elementsong_admin/mdimage/raw/master/20201121125157.png)

#### 抢占式调度详解

大部分操作系统都支持多进程并发运行，现在的操作系统几乎都支持同时运行多个程序。比如：现在我们上课一边使用编辑器，一边使用录屏软件，同时还开着画图板，dos窗口等软件。此时，这些程序是在同时运行，”感觉这些软件好像在同一时刻运行着“。

![](https://gitee.com/elementsong_admin/mdimage/raw/master/20201121125158.png)
...
该如何创建线程呢？通过API中搜索，查到Thread类。通过阅读Thread类中的描述。Thread是程序中的执行线程。Java虚拟机允许应用程序并发地运行多个执行线程。

![](https://gitee.com/elementsong_admin/mdimage/raw/master/20201121125159.png)

-   构造方法

![](https://gitee.com/elementsong_admin/mdimage/raw/master/20201121125200.png)

-   常用方法

![](https://gitee.com/elementsong_admin/mdimage/raw/master/20201121125201.png)

继续阅读，发现创建新执行线程有两种方法。

-   一种方法是将类声明为 Thread 的子类。该子类应重写 Thread 类的 run
    方法。创建对象，开启线程。run方法相当于其他线程的main方法。

-   另一种方法是声明一个实现 Runnable 接口的类。该类然后实现 run
    方法。然后创建Runnable的子类对象，传入到某个线程的构造方法中，开启线程。
...
![](https://gitee.com/elementsong_admin/mdimage/raw/master/20201121125202.png)
...
![](https://gitee.com/elementsong_admin/mdimage/raw/master/20201121125203.png)
...
查看Runnable接口说明文档：Runnable接口用来指定每个线程要执行的任务。包含了一个
run 的无参数抽象方法，需要由接口实现类重写该方法。

![](https://gitee.com/elementsong_admin/mdimage/raw/master/20201121125204.png)

-   接口中的方法

![](https://gitee.com/elementsong_admin/mdimage/raw/master/20201121125205.png)

-   Thread类构造方法

![](https://gitee.com/elementsong_admin/mdimage/raw/master/20201121125206.png)
...
![](https://gitee.com/elementsong_admin/mdimage/raw/master/20201121125207.png)
...
-   Executors：线程池创建工厂类
    ...
    -   `public static ExecutorService newFixedThreadPool(intnThreads)：`返回线程池对象
