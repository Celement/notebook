...
![](assets/20201121125154.png)

线程：线程是进程中的一个执行单元，负责当前进程中程序的执行，一个进程中至少有一个线程。一个进程中是可以有多个线程的，这个应用程序也可以称之为多线程程序。

简而言之：一个程序运行后至少有一个进程，一个进程中可以包含多个线程

![](assets/20201121125155.png)
...
![](assets/20201121125157.png)

#### 抢占式调度详解

大部分操作系统都支持多进程并发运行，现在的操作系统几乎都支持同时运行多个程序。比如：现在我们上课一边使用编辑器，一边使用录屏软件，同时还开着画图板，dos窗口等软件。此时，这些程序是在同时运行，”感觉这些软件好像在同一时刻运行着“。

![](assets/20201121125158.png)
...
![](assets/20201121125159.png)

-   构造方法

![](assets/20201121125200.png)

-   常用方法

![](assets/20201121125201.png)
...
![](assets/20201121125204.png)

-   接口中的方法

![](assets/20201121125205.png)

-   Thread类构造方法

![](assets/20201121125206.png)
