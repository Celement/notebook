...
![](media/770066dc7a2970ea8af750692e66d204.png)

获取全局参数

![](media/c8d9db93dd8d824297ae5e416c0dc3e0.png)
...
![](media/78827b91268144df1d6a7b167b97e343.png)

### 通过classloader去获取web工程下的资源

![](media/5b78ba07482b48f314a781b87af133e9.png)

### 使用ServletContext存取数据。

1.  定义一个登陆的html页面， 定义一个form表单

![](media/d935c8639d06abc200037e3c5348a355.png)

1.  定义一个Servlet，名为LoginServlet

![](media/28dedeae42ed11de6157075bc25d595c.png)

1.  针对成功或者失败，进行判断，然后跳转到不一样的网页

![](media/61f01fe79db691f86915462c7f8af04c.png)

### ServletContext存取值分析

![](media/71ab92249a96b767ef4102bfe6bff062.png)
...
![](media/9fd9f314459343b8580559192687f405.png)
...
![](media/f2d2b66e0b5c2dd7830b753ddd7101a6.png)
