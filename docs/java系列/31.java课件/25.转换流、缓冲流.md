...
查阅OutputStreamWriter的API介绍，OutputStreamWriter
是字符流通向字节流的桥梁：可使用指定的字符编码表，将要写入流中的字符编码成字节。它的作用的就是，将字符串按照指定的编码表转成字节，在使用字节流将这些字节写出去。

![](https://gitee.com/elementsong_admin/mdimage/raw/master/20201121085257.png)
...
![](https://gitee.com/elementsong_admin/mdimage/raw/master/20201121085258.png)
...
public [String](java.lang%20中的类) readLine()
