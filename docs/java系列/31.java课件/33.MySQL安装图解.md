...
![](media/7ac1ad6ca62438e1ce64dcc5a059dc0b.png)

![](media/95c815382d8178148403f2aaac429894.png)

２、选择安装类型，有“Typical（默认）”、“Complete（完全）”、“Custom（用户自定义）”三个选项，选择“Custom”，按“next”键继续。

![](media/1df7bbd6bbd3ced515852be2cfbc4ddf.png)

３、点选“Browse”，手动指定安装目录。

![](media/a4567de92c8c2d522f0f0326cacac926.png)

４、填上安装目录，我的是“F:\\Server\\MySQL\\MySQL Server
5.0”，也建议不要放在与操作系统同一分区，这样可以防止系统备份还原的时候，数据被清空。按“OK”继续。

![](media/40aabbf42137701b8e08cbf4258e3379.png)

确认一下先前的设置，如果有误，按“Back”返回重做。按“Install”开始安装。

![](media/8333f91593ecca16895c487960f471bb.png)

![](media/09b2064046ef43b7176c525563fdd2ee.png)

![](media/8b7febb14455e58d887b0d7ada75c9c7.png)

５、正在安装中，请稍候，直到出现下面的界面, 则完成MYSQL的安装

![](media/bc889000426b5e5c032e6c592f831c87.png)
...
![](media/a20c71473e926fb86977e48502e52a34.png)
...
![](media/8844b6b8c5317c28050e0098229bc7ac.png)

５、选择网站并发连接数，同时连接的数目，“Decision
Support(DSS)/OLAP（20个左右）”、“Online Transaction
Processing(OLTP)（500个左右）”、“Manual Setting（手动设置，自己输一个数）”。

![](media/a604960164a80fc137c33bbf07ad5559.png)

![](media/8e788bcc97179f4dcdcbd692650a6258.png)
...
![](media/d9a5a510e69ddaf56d2b76ee7bec6c98.png)

７、就是对mysql默认数据库语言编码进行设置（重要），一般选UTF-8，按 “Next”继续。

![](media/37e658973dd40d01f3126717cfaff987.png)
...
![](media/97c62b656ef5a3d0689408e9b6018d1c.png)
...
![](media/ae4dc91946acbb96ca0ec826fc6f377b.png)

１０、确认设置无误，按“Execute”使设置生效，即完成MYSQL的安装和配置。

![](media/277be9eb18fb355e3f4fe64e2ea32374.png)

![](media/eaf33ac50df49faac36515051f3d53a3.png)
...
![](media/125ed33fc09f7031454ca333d5fc222c.png)
