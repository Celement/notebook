...
![image-20201120103546285](https://gitee.com/elementsong_admin/mdimage/raw/master/20201120103546.png)

![image-20201120103641340](https://gitee.com/elementsong_admin/mdimage/raw/master/20201120103641.png)
...
当使用迭代器遍历集合的时候,使用了集合中的 增加/删除 方法,导致并发修改异常产生       //ctrl+h
...
以上代码会发生强制转换异常,原因就是String str = (String)it.next()
,存入集合的是Student,而强转为String,String与Student之间没有任何子父关系不能强转,未使用泛型前有可能发声强制转换异常的问题
...
![](https://gitee.com/elementsong_admin/mdimage/raw/master/20201121084213.png)
...
![](https://gitee.com/elementsong_admin/mdimage/raw/master/20201121084214.png)
...
![](https://gitee.com/elementsong_admin/mdimage/raw/master/20201121084215.png)
...
return x;//如果我们传入的对象和list中的对象一样了 我把当前的索引给返回回去
