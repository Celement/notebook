...
网络通信协议有很多种，目前应用最广泛的是TCP/IP协议(Transmission Control
Protocal/Internet
Protoal传输控制协议/英特网互联协议)，它是一个包括TCP协议和IP协议，UDP（User
Datagram
Protocol）协议和其它一些协议的协议组，在学习具体协议之前首先了解一下TCP/IP协议组的层次结构。

在进行数据传输时，要求发送的数据与收到的数据完全一样，这时，就需要在原有的数据上添加很多信息，以保证数据在传输过程中数据格式完全一致。TCP/IP协议的层次结构比较简单，共分为四层，如图所示。

![](https://gitee.com/elementsong_admin/mdimage/raw/master/20201121125452.png)

>   图1-1TCP/IP网络模型

上图中，TCP/IP协议中的四层分别是应用层、传输层、网络层和链路层，每层分别负责不同的通信功能，接下来针对这四层进行详细地讲解。

> 链路层：[链路层](_blank)是用于定义物理传输通道，通常是对某些网络连接设备的驱动协议，例如针对光纤、[网线](_blank)提供的驱动。
>
...
在TCP/IP协议中，这个标识号就是IP地址，它可以唯一标识一台计算机，目前，IP地址广泛使用的版本是IPv4，它是由4个字节大小的二进制数来表示，如：00001010000000000000000000000001。由于二进制形式表示的IP地址非常不便记忆和处理，因此通常会将IP地址写成十进制的形式，每个字节用一个十进制数字(0-255)表示，数字间用符号“.”分开，如
`192.168.1.100。`
...
![](https://gitee.com/elementsong_admin/mdimage/raw/master/20201121125453.jpg)
...
![](https://gitee.com/elementsong_admin/mdimage/raw/master/20201121125454.png)
...
InetAddress remote = InetAddress.getByName("www.paojiao.cn");

System.out.println("本机的IP地址：" + local.getHostAddress());

System.out.println("pp的IP地址：" + remote.getHostAddress());

System.out.println("pp的主机名为：" + remote.getHostName());
...
在介绍TCP/IP结构时，提到传输层的两个重要的高级协议，分别是UDP和TCP，其中UDP是User
Datagram Protocol的简称，称为用户数据报协议，TCP是Transmission Control
...
![](https://gitee.com/elementsong_admin/mdimage/raw/master/20201121125455.jpg)
...
![](https://gitee.com/elementsong_admin/mdimage/raw/master/20201121125456.jpg)
...
![](https://gitee.com/elementsong_admin/mdimage/raw/master/20201121125457.png)
...
![](https://gitee.com/elementsong_admin/mdimage/raw/master/20201121125458.png)
...
![](https://gitee.com/elementsong_admin/mdimage/raw/master/20201121125459.png)
...
![](https://gitee.com/elementsong_admin/mdimage/raw/master/20201121125500.jpg)

在创建发送端和接收端的DatagramSocket对象时，使用的构造方法也有所不同，下面对DatagramSocket类中常用的构造方法进行讲解。

![](https://gitee.com/elementsong_admin/mdimage/raw/master/20201121125501.png)

该构造方法用于创建发送端的DatagramSocket对象，在创建DatagramSocket对象时，并没有指定端口号，此时，系统会分配一个没有被其它网络程序所使用的端口号。

![](https://gitee.com/elementsong_admin/mdimage/raw/master/20201121125502.png)
...
![](https://gitee.com/elementsong_admin/mdimage/raw/master/20201121125503.png)
...
![](https://gitee.com/elementsong_admin/mdimage/raw/master/20201121125504.png)
...
![](https://gitee.com/elementsong_admin/mdimage/raw/master/20201121125505.png)

使用该构造方法在创建ServerSocket对象时，就可以将其绑定到一个指定的端口号上（参数port就是端口号）。

接下来学习一下ServerSocket的常用方法，如表所示。

![](https://gitee.com/elementsong_admin/mdimage/raw/master/20201121125506.png)
...
![](https://gitee.com/elementsong_admin/mdimage/raw/master/20201121125507.png)

使用该构造方法在创建Socket对象时，会根据参数去连接在指定地址和端口上运行的服务器程序，其中参数host接收的是一个字符串类型的IP地址。

![](https://gitee.com/elementsong_admin/mdimage/raw/master/20201121125508.png)
...
![](https://gitee.com/elementsong_admin/mdimage/raw/master/20201121125509.png)
...
![](https://gitee.com/elementsong_admin/mdimage/raw/master/20201121125510.jpg)
...
![](https://gitee.com/elementsong_admin/mdimage/raw/master/20201121125511.png)
...
![](https://gitee.com/elementsong_admin/mdimage/raw/master/20201121125512.png)
