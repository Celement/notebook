...
![图片](https://mmbiz.qpic.cn/mmbiz_png/SfAHMuUxqJ3VMtibPPw2Fn98uzdrtC5wRzsdCn5Fibrle7Gtbfc9vt55iaicuxfCHJCS2DChLMmprldcl3Yib8WQkmA/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)角色
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/SfAHMuUxqJ3VMtibPPw2Fn98uzdrtC5wRyxGXwqegibS4df6D40HGH6ntQcTJBeMU2qwO3DbU34CTIS81OCx3Kaw/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)数据库服务器

### 3.2 客户端

左边绿色的实心圈就是客户端，右边的蓝色实心圈就是节点 a（Node a）。Term 代表任期，后面会讲到。

![图片](https://mmbiz.qpic.cn/mmbiz_png/SfAHMuUxqJ3VMtibPPw2Fn98uzdrtC5wRhw2CreFTsjWVqx8hfZSB0Wnhb4DGHtXP6t6odtOXYRtIHlZYHUibK2g/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)客户端

### 3.3 客户端向服务器发送数据

客户端向单节点服务器发送了一条更新操作，设置数据库中存的值为 8。单机环境下（单个服务器节点），客户端从服务器拿到的值也是 8。一致性非常容易保证。

![图片](https://mmbiz.qpic.cn/mmbiz_gif/SfAHMuUxqJ3VMtibPPw2Fn98uzdrtC5wRRjDWS2C8RR661ibrmEusnjxLZkECwf22icKn7pzZ2mq05pK55IBmIqSw/640?wx_fmt=gif&tp=webp&wxfrom=5&wx_lazy=1)客户端向服务器发送数据
...
![图片](https://mmbiz.qpic.cn/mmbiz_gif/SfAHMuUxqJ3VMtibPPw2Fn98uzdrtC5wRnpibKnib05ooo9eQJOcbibLkzpKBrbvvoKwzHO5DYtTuicWnpbnicq77sQA/640?wx_fmt=gif&tp=webp&wxfrom=5&wx_lazy=1)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/SfAHMuUxqJ3VMtibPPw2Fn98uzdrtC5wRu4vPDHwv1ZjbhJicmeI24AW8CatFIP1LPU6oUeTS0R7VwUfCicWl3tMA/640?wx_fmt=png&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)初始状态
...
![图片](https://mmbiz.qpic.cn/mmbiz_gif/SfAHMuUxqJ3VMtibPPw2Fn98uzdrtC5wRdn6lO8ZlA4tvPWzC4ou811IZD6hoNFThC1XkYpu1GvYBdMfpxKDHUA/640?wx_fmt=gif&tp=webp&wxfrom=5&wx_lazy=1)超时时间
...
![图片](https://mmbiz.qpic.cn/mmbiz_gif/SfAHMuUxqJ3VMtibPPw2Fn98uzdrtC5wRxv5MD6VoLJuftsLY86zwzpnFXQKjFdXybUKkrdkbs7TwEYueWcGhTw/640?wx_fmt=gif&tp=webp&wxfrom=5&wx_lazy=1)成为候选者

### 4.3 投票

我们来看下候选者如何成为领导者的。

![图片](https://mmbiz.qpic.cn/mmbiz_gif/SfAHMuUxqJ3VMtibPPw2Fn98uzdrtC5wRgrZOsIujRKfiafJuqmjjtrPjAt1h7IZloO9YYicZ8YI1550iavdmHhEkA/640?wx_fmt=gif&tp=webp&wxfrom=5&wx_lazy=1)Leader 选举
...
![图片](https://mmbiz.qpic.cn/mmbiz_gif/SfAHMuUxqJ3VMtibPPw2Fn98uzdrtC5wRicfFJyhC6SJx6xLibx6wN8SJI5ozct5zLOSGiaz8vWcVpgBneKEMW2OEA/640?wx_fmt=gif&tp=webp&wxfrom=5&wx_lazy=1)领导者故障
...
golang   本篇通过动图的方式来讲解 Raft 算法如何选举领导者，更容易理解和消化。