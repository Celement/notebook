...
访问属性：变量名.属性
(这是当前的方式，后期会采取调用方法的方式替代掉直接访问的方式来完成对属性的访问。)
...
![](https://gitee.com/elementsong_admin/mdimage/raw/master/20201118140612.png)
...
![](https://gitee.com/elementsong_admin/mdimage/raw/master/20201118140613.png)
