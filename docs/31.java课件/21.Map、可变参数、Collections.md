...
![image-20201120103409906](https://gitee.com/elementsong_admin/mdimage/raw/master/20201120103410.png)
...
![](https://gitee.com/elementsong_admin/mdimage/raw/master/20201121084447.png)
...
![](https://gitee.com/elementsong_admin/mdimage/raw/master/20201121084448.png)
...
![](https://gitee.com/elementsong_admin/mdimage/raw/master/20201121084449.png)
...
![](https://gitee.com/elementsong_admin/mdimage/raw/master/20201121084450.png)
...
![](https://gitee.com/elementsong_admin/mdimage/raw/master/20201121084451.png)

-   Entry是Map接口中提供的一个静态内部嵌套接口。

![](https://gitee.com/elementsong_admin/mdimage/raw/master/20201121084452.png)

-   getKey()方法：获取Entry对象中的键

-   getValue()方法：获取Entry对象中的值

![](https://gitee.com/elementsong_admin/mdimage/raw/master/20201121084453.png)
...
![](https://gitee.com/elementsong_admin/mdimage/raw/master/20201121084454.png)

2.遍历包含键值对(Entry)对象的Set集合，得到每一个键值对(Entry)对象

3.通过键值对(Entry)对象，获取Entry对象中的键与值。

![](https://gitee.com/elementsong_admin/mdimage/raw/master/20201121084455.png)

![](https://gitee.com/elementsong_admin/mdimage/raw/master/20201121084456.png)
...
> 练习：每位学生（姓名，年龄）都有自己的家庭住址。那么，既然有对应关系，则将学生对象和家庭住址存储到map集合中。学生作为键,
> 家庭住址作为值。
>
...
![](https://gitee.com/elementsong_admin/mdimage/raw/master/20201121084457.png)
...
![](https://gitee.com/elementsong_admin/mdimage/raw/master/20201121084458.png)
...
![](https://gitee.com/elementsong_admin/mdimage/raw/master/20201121084459.png)
...
![](https://gitee.com/elementsong_admin/mdimage/raw/master/20201121084500.png)
...
for (String thisNumber : number) { //1-13

for (String thisColor : color) { //1-4
...
HashMap和Hashtable都实现了Map接口，因此很多特性非常相似。但是，他们有以下不
同点：

HashMap允许键和值是null，而Hashtable不允许键或者值是null。

Hashtable是同步的，而HashMap不是。因此，HashMap更适合于单线程环境，而Hashtable
适合于多线程环境。

HashMap提供了可供应用迭代的键的集合，因此，HashMap是快速失败的。另一方面，
...
>
>   V remove(Object key) 把指定的键 所对应的键值对元素
>   在Map集合中删除，返回被删除元素的值
>
...
>   底层采用哈希表+链表结构
>
>   LinkedHashMap集合中的key不能重复，通过重写hashCode() 与equals()方法来保证键的唯一。
