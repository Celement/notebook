## Mybatis_day03:输入映射和输出映射, 动态sql,关联查询, Mybatis整合spring
...
![](https://gitee.com/elementsong_admin/mdimage/raw/master/20201028234653.png)
...
![](https://gitee.com/elementsong_admin/mdimage/raw/master/20201028234654.png)
...
![](https://gitee.com/elementsong_admin/mdimage/raw/master/20201028234655.png)
...
<select id="findOrdersList" resultType="com.pp.mybatis.po.OrdersCustom">
...
<resultMap type="com.pp.po.Orders" id="orderUserResultMap">
...
<association property="user" javaType="com.pp.po.User">
...
property：表示关联查询的结果存储在com.pp.mybatis.po.Orders的user属性中

javaType：表示关联查询的结果类型

<id property="id"

column="user_id"/>：查询结果的user_id列对应关联对象的id属性，这里是<id

/>表示user_id是关联查询对象的唯一标识。
...
```java
<resultMap type="com.pp.po.user" id="userOrderResultMap">
...
<collection property="orders" ofType="com.pp.po.Orders">
...
![](https://gitee.com/elementsong_admin/mdimage/raw/master/20201028234656.png)
...
![](https://gitee.com/elementsong_admin/mdimage/raw/master/20201028234657.png)
